...
def getAllImages():
    ...
    cards_imagen = []
    for imagen in imagenes:                                # Se itera sobre cada imagen cruda.
        cardImagen = translator.fromRequestIntoCard(imagen)     # Se utiliza 'formRequestIntoCard()' para convertirla en una tarjeta.
        cards_imagen.append(cardImagen)                         # Cada tarjeta se añade a la lista 'cards_imagen'.
